...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/auth/sms-verification/sms-verification').then((m) => m.SmsVerification),
  },
  {
    path: 'confirm-password',
    loadComponent: () =>
      import('./pages/auth/confirm-password/confirm-password').then((m) => m.ConfirmPassword),
  },
  {
    path: 'company-setup',
    loadComponent: () =>
      import('./pages/auth/company-setup/company-setup').then((m) => m.CompanySetup),
  },
  ...
  // ─── Main App Layout (With Sidenav/Header Shell) ───────────────────────
  {
    ...
    children: [
      ...
      },
      {
        path: 'company-branch',
        loadComponent: () =>
          import('./pages/company-branch/company-branch').then((m) => m.CompanyBranch),
      },
      {
        path: 'user-registration',
        loadComponent: () =>
          import('./pages/user-registration/user-registration').then((m) => m.UserRegistration),
      },
      {
        path: 'support',
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/notification-history/notification-history').then(
            (m) => m.NotificationHistory,
          ),
      },
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/petty-cash-list/petty-cash-list').then((m) => m.PettyCashList),
      },
      {
        path: 'collection',
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/collection-list/collection-list').then((m) => m.CollectionList),
      },
      {
        path: 'payments',
      ...
      },
      {
        path: 'referral-guide',
        loadComponent: () =>
          import('./pages/referral-guide/referral-guide').then((m) => m.ReferralGuide),
      },
      {
        path: 'referral-guide/list',
        loadComponent: () =>
          import('./pages/referral-guide-list/referral-guide-list').then(
            (m) => m.ReferralGuideList,
          ),
      },
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/purchase-list/purchase-list').then((m) => m.PurchaseList),
      },
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/stock-adjustment/stock-adjustment').then((m) => m.StockAdjustment),
      },
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/customers-suppliers/customers-suppliers').then(
            (m) => m.CustomersSuppliers,
          ),
      },
      {
        path: 'unit-measures',
        loadComponent: () =>
          import('./pages/unit-measures/unit-measures').then((m) => m.UnitMeasures),
      },
