...
export const PRODUCTS: Producto[] = [
  ...
  { id: 's01', sku: 'SVC-001', descripcion: 'Delivery a domicilio',       categoria: '', precio_publico:  8.00, precio_mayor:  7.00, costo:  2.50, marca: '', unidad: '', estado: 'ACTIVO',   st_producto: 0, stock: 0, stock_min: 0, sigla: 'S/' },
  { id: 's02', sku: 'SVC-002', descripcion: 'Servicio técnico',           categoria: '', precio_publico: 80.00, precio_mayor: 70.00, costo: 20.00, marca: '', unidad: '', estado: 'ACTIVO',   st_producto: 0, stock: 0, stock_min: 0, sigla: 'S/' },
  { id: 's03', sku: 'SVC-003', descripcion: 'Consultoría mensual',        categoria: '', precio_publico: 250.00, precio_mayor: 220.00, costo: 80.00, marca: '', unidad: '', estado: 'ACTIVO',  st_producto: 0, stock: 0, stock_min: 0, sigla: 'S/' },
  { id: 's04', sku: 'SVC-004', descripcion: 'Instalación y configuración',categoria: '', precio_publico: 120.00, precio_mayor: 100.00, costo: 35.00, marca: '', unidad: '', estado: 'INACTIVO', st_producto: 0, stock: 0, stock_min: 0, sigla: 'S/' },
];
