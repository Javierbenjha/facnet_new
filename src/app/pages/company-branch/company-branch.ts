...
export class CompanyBranch {
  ...
  openNewEmpresa()               { this.editingEmpresa.set('new'); }
  openEditEmpresa(e: Empresa)    { this.editingEmpresa.set(e); }
  closeEmpresaForm()             { this.editingEmpresa.set(null); }

  openNewSucursal()              { this.editingSucursal.set('new'); }
  openEditSucursal(s: Sucursal)  { this.editingSucursal.set(s); }
  closeSucursalForm()            { this.editingSucursal.set(null); }
